...
if(config('activitylog.database_connection') === 'mongodb') {
    class DynamicParent extends \Jenssegers\Mongodb\Eloquent\Model {}
} else {
    class DynamicParent extends  \Illuminate\Database\Eloquent\Model {}
}

class Activity extends DynamicParent implements ActivityContract
{
    public $guarded = [];
